    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vip_days', models.DateTimeField(blank=True, null=True, verbose_name='会员到期时间')),
                ('status', models.IntegerField(choices=[(0, '正常'), (1, '禁言'), (2, '冻结'), (3, '其他')], default=0, verbose_name='用户状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content_type', models.CharField(choices=[('content', '内容'), ('dynamic', '动态'), ('advertise', '广告')], max_length=20, verbose_name='content,dynamic')),
                ('object_id', models.IntegerField(db_index=True, verbose_name='关联内容ID')),
